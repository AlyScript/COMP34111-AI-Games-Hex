...
class MaestroBaseAgent(AgentBase):
        ...
        for r in range(self.board_size):
            for c in range(self.board_size):
                ...
                if tile_c == self.colour:
                    ...
                    shadow_board.place(r * self.board_size +
        ...
        while time.time() - start_time < time_budget:
            ...
            while node.untried_moves == [] and node.children:
                ...
                while t.parent:
                    depth += 1
                    t = t.parent
                mover = self.colour if (
                    depth % 2 != 0) else self.opponent_colour
            ...
            if node.untried_moves:
                ...
                exp_mover = (
                    self.colour if (node.depth %
                                    2 == 0) else self.opponent_colour
                )
            ...
            next_mover = self.opponent_colour if (
                node.depth % 2 != 0) else self.colour
            ...
            while winner_colour is None and empty_working_set:
                ...
                if last_move_idx is not None and random.random() < 0.8:
                    ...
                    valid_neighbors = [
                        n for n in neighbors if n in empty_working_set]
                    if valid_neighbors:
    ...
    def select_child_rave(self, node):
        ...
        for child in node.children:
            ...
            beta = math.sqrt(self.rave_bias /
                             (3 * node.visits + self.rave_bias))
